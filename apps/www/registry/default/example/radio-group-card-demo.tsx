import { RadioGroup, RadioGroupCard } from "@/registry/default/ui/radio-group"
    ...
    <RadioGroup defaultValue="ground" className="flex space-x-2">
      <RadioGroupCard value="ground">
        <div className="p-6">
          ...
          <p className="text-sm">Deliver within 5-8 business day</p>
        </div>
      </RadioGroupCard>
      ...
      <RadioGroupCard value="air">
        <div className="p-6">
          ...
          <p className="text-sm">Deliver within 3-5 business day</p>
        </div>
      </RadioGroupCard>
    </RadioGroup>
  )
